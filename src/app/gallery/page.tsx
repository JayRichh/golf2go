...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Gallery',
    description: 'View our portable mini golf courses in action at various events and locations across New Zealand.',
  };
}
        ...
        <GradientBackground variant="glow">
          <Container size="xl" className="py-32 md:py-40">
            <div className="text-center">
              ...
              <Text variant="xl" className="mx-auto mt-6 max-w-2xl text-center text-primary-foreground/90">
